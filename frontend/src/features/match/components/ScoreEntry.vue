...
<template>
  <div class="w-full flex flex-col bg-surface-container-low rounded-2xl p-4">
    <div class="relative flex items-center justify-center mb-6">
      <BaseButton variant="secondary" @click="emit('back')" class="!h-10 px-4 absolute left-0"
        >Back</BaseButton
      >
      ...
      <BaseButton
        ...
        class="!h-10 px-4 absolute right-0"
        >Cancel</BaseButton
      >
    </div>
    ...
    <div class="flex flex-col items-center mb-4 gap-2 w-full">
      ...
      <div
        class="flex items-center justify-between w-full px-4 mb-1 text-[10px] font-bold text-on-surface-variant uppercase tracking-wider"
      >
