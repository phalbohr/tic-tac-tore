...
<template>
  <div class="ch-empty-state w-full flex items-center justify-center p-4">
    <div
      class="w-full max-w-sm bg-surface-container-low rounded-2xl p-6 space-y-6 shadow-2xl text-center"
    >
      <div
        class="inline-flex items-center justify-center w-16 h-16 rounded-full bg-primary-container text-primary mb-2"
      >
        ...
        <h2 class="font-headline text-xl font-bold text-on-surface mb-2">
          {{
            ...
            (props.opponentNickname
              ...
              : t('stats.noMatchesYet', 'No Matches Yet'))
          }}
        </h2>
      ...
      <div class="flex flex-col gap-3 pt-2">
        ...
        >
          ...
          {{
            props.opponentId
              ? t('h2h.startMatch', 'Start a match')
              : t('stats.recordFirstMatch', 'Record First Match')
          }}
        </button>
