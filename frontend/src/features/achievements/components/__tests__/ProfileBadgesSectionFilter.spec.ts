...
describe.skip('[Story 7.3 ATDD Red Phase] ProfileBadgesSection.vue Category Filtering & Modal Progress', () => {
  beforeEach(() => {
    setActivePinia(createPinia())
    const authStore = useAuthStore()
    authStore.profile = { id: 'p-1', nickname: 'Alex', email: 'alex@test.com' } as any
  })
  ...
  it('[P0] [AC1] should render category filter tabs (All, Badges, Anti-Achievements)', async () => {
    ...
    store.achievements = mockAchievements as any
