...
const FORBIDDEN: Array<{ pattern: RegExp; label: string }> = [
  { pattern: /\bml-\d/, label: 'ml-* (use ms-*)' },
  { pattern: /\bmr-\d/, label: 'mr-* (use me-*)' },
  { pattern: /\bpl-\d/, label: 'pl-* (use ps-*)' },
  { pattern: /\bpr-\d/, label: 'pr-* (use pe-*)' },
  { pattern: /\bborder-l[-\d]/, label: 'border-l-* (use border-s-*)' },
  { pattern: /\bborder-r[-\d]/, label: 'border-r-* (use border-e-*)' },
  { pattern: /\btext-left\b/, label: 'text-left (use text-start)' },
  { pattern: /\btext-right\b/, label: 'text-right (use text-end)' },
  { pattern: /\bleft-\d/, label: 'left-* (use start-*)' },
  { pattern: /\bright-\d/, label: 'right-* (use end-*)' },
