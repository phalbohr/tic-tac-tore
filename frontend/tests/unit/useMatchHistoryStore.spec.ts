...
// Red-phase scaffold placeholder: useMatchHistoryStore will be created in Task 3
// import { useMatchHistoryStore } from '@/features/match/stores/useMatchHistoryStore'

describe('[Story 4.6] useMatchHistoryStore - Unified Match History (ATDD Red Phase)', () => {
  beforeEach(() => {
  ...
  it.skip('[P0] should fetch and store paginated confirmed match history', async () => {
    ...
    //   last: true
    // }
    // vi.mocked(matchService.getMatchHistory).mockResolvedValue(mockPagedResponse)
  ...
  it.skip('[P0] should switch tabs between confirmed and pending', () => {
    // const store = useMatchHistoryStore()
  ...
  it.skip('[P1] should pass filter parameters (playerId, matchType, ruleConfigId) and cancel in-flight requests', async () => {
    // const store = useMatchHistoryStore()
  ...
  it.skip('[P1] should reset filters to default state', () => {
    // const store = useMatchHistoryStore()
  ...
  it.skip('[P2] should generate realistic demo match history when demo mode is active or user has 0 matches', async () => {
    // const store = useMatchHistoryStore()
