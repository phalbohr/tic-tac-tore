...
- [ ] Task 1: Database Migration & JPA Entities (AC2, AC3, AC5)
  ...
  - [ ] Create Entities in `com.tictactore.model`:
  ...
  - [ ] Create Repositories in `com.tictactore.repository`:
  ...
  - [ ] Update `MatchmakingPoolRepositoryTest.java` verifying cascade saves, unique participant constraints, and index queries.
- [ ] Task 2: Backend DTOs, Service & Controller (AC1, AC2, AC3, AC4, AC5)
  ...
  - [ ] Create `PoolService.java` & `PoolServiceImpl.java` in `com.tictactore.service`:
  ...
  - [ ] Create `PoolController.java` in `com.tictactore.controller`:
...
- [ ] Task 3: Frontend Types, Service & Pinia Store (AC1, AC2, AC3, AC6)
  - [ ] Create `frontend/src/features/matchmaking/types/pool.ts` with TypeScript interfaces matching backend DTOs and enums.
  - [ ] Create `frontend/src/features/matchmaking/services/poolService.ts` calling `/api/v1/pools`.
  - [ ] Create `frontend/src/features/matchmaking/stores/poolStore.ts`:
    - State: `activePools`, `currentPool`, `isLoading`, `error`.
    - Actions: `createPool(payload: CreatePoolPayload)`, `fetchPool(id: string)`.
  - [ ] Frontend store tests in `frontend/src/features/matchmaking/stores/__tests__/poolStore.spec.ts`.
- [ ] Task 4: Frontend UI Components & Home Hub Integration (AC1, AC6)
  - [ ] Create `frontend/src/features/matchmaking/components/CreatePoolModal.vue`:
  ...
  - [ ] Add i18n translation keys in `frontend/src/locales/en.json` and `frontend/src/locales/de.json` for all modal labels, options, errors, and toast messages.
  - [ ] Component unit tests in `frontend/src/features/matchmaking/components/__tests__/CreatePoolModal.spec.ts`.
