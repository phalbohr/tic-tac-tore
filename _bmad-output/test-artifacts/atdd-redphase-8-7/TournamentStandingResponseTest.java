...
@Disabled("ATDD red phase: Story 8.7 - Pending DTO record enhancement")
@DisplayName("TournamentStandingResponse DTO record")
class TournamentStandingResponseTest {

    @Test
    @DisplayName("Should construct with full standings statistics, ranking, and partner attributes")
