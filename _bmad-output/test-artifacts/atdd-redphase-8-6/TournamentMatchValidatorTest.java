...
class TournamentMatchValidatorTest {
    ...
    void setUp() {
        ...
        User user1 = User.builder().id(user1Id).nickname("Alice").build();
        User user2 = User.builder().id(user2Id).nickname("Bob").build();

        reg1 = TournamentRegistration.builder().id(UUID.randomUUID()).user(user1).build();
        reg2 = TournamentRegistration.builder().id(UUID.randomUUID()).user(user2).build();
    ...
    void shouldThrowWhenRuleConfigIdMismatches() {
        UUID wrongRuleConfigId = UUID.randomUUID();
