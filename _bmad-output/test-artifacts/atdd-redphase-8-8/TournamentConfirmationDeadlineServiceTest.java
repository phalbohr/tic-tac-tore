...
import com.tictactore.operation.MatchOperation;
...
@DisplayName("TournamentConfirmationDeadlineService ATDD Unit Tests")
class TournamentConfirmationDeadlineServiceTest {
    ...
    @Test
    @DisplayName("[P0] Should process expired matches by auto-confirming and saving via MatchOperation")
    ...
    @Test
    @DisplayName("[P1] Should return 0 when no expired matches exist")
    ...
    @Test
    @DisplayName("[P0] Should isolate errors per match and continue processing subsequent expired matches")
