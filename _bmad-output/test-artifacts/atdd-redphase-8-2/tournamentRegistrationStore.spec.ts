...
describe('Tournament Registration Store ATDD Specs — Story 8.2', () => {
  beforeEach(() => {
  ...
  it('should cancel registration and clear myRegistrations state (AC 5)', async () => {
    ...
    expect(registrationService.cancelRegistration).toHaveBeenCalledWith(tournamentId, registrationId);
