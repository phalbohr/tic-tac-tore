...
class PoolNotificationListenerTest {
    ...
    class PoolCreatedEventTests {
        ...
        @Test
        @DisplayName("[P0] Should query eligible subscribers excluding creator and dispatch push notification (AC 1)")
        ...
        @Test
        @DisplayName("[P1] Should not dispatch push notifications when no eligible subscribers found")
        void shouldNotDispatchWhenNoEligibleSubscribers() {
            ...
            PoolCreatedEvent event = new PoolCreatedEvent(poolId, creatorId, MatchType.TWO_VS_TWO, SkillLevel.PRO, "Host");
        ...
        @Test
        @DisplayName("[P0] Should catch any push service exceptions gracefully without bubbling up (AC 5)")
    ...
    class PoolFilledEventTests {
        ...
        @Test
        @DisplayName("[P0] Should fetch participants and dispatch POOL_FILLED push notifications (AC 2)")
        ...
        @Test
        @DisplayName("[P0] Should catch any push service exceptions gracefully on POOL_FILLED (AC 5)")
