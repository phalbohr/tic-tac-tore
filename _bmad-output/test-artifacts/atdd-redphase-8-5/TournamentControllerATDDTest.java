...
@DisplayName("TournamentController Match Start & Cancel ATDD Specifications")
class TournamentControllerATDDTest {
    ...
    class StartMatchEndpointSpecs {
        ...
        @DisplayName("Should start match and return 200 OK with IN_PROGRESS status")
        ...
        @Test
        @WithMockUser(username = "a1b2c3d4-e5f6-7890-abcd-ef1234567890")
        @DisplayName("Should return 409 Conflict when participant is busy in another active match")
        ...
        @Test
        @WithAnonymousUser
        @DisplayName("Should return 401 Unauthorized when unauthenticated user attempts to start match")
    ...
    class CancelMatchEndpointSpecs {
        ...
        @Test
        @WithMockUser(username = "a1b2c3d4-e5f6-7890-abcd-ef1234567890")
        @DisplayName("Should cancel match and return 200 OK with READY status")
