...
inputDocuments:
  ...
  - ".gemini/project-spec/DESIGN/stitch_tic_tac_tore/pitch_parquet/DESIGN.md"
  - ".gemini/project-spec/table-soccer-rules/ITSF_Standard_Matchplay_Rules_2024.md"
  - ".gemini/project-spec/table-soccer-rules/ITSF-Regelwerk_Kurzfassung.md"
  - ".gemini/project-spec/table-soccer-rules/Regularien_der_Bundesligen_2024.md"
  - "docs/index.md"
