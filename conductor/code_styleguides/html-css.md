...
### Vue 3 Styling
For Vue 3 specific styling guidelines, including Single-File Components (SFC), directives, and component structure, please refer to:
- [Vue 3 Style Guide](./vue3-style-guide.md)

### SCSS Styling
For SCSS syntax, nesting rules, and BEM naming conventions, please refer to:
