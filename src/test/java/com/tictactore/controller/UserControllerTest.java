...
class UserControllerTest {
        ...
        void patchMe_shouldUpdateLanguageAndNickname() throws Exception {
                ...
                result.andExpect(status().isOk())
                                ...
                                .andExpect(org.springframework.test.web.servlet.result.MockMvcResultMatchers.header()
                                                .string("Set-Cookie", org.hamcrest.Matchers
                                                                .containsString("TTT_TOKEN=newToken")));
        ...
        void patchMe_shouldReturn400_whenCooldownNotPassed() throws Exception {
                ...
                when(userService.updateProfile(eq(userId), any(UpdateProfileRequest.class)))
                                .thenThrow(new com.tictactore.exception.ValidationException(
                                                "Nickname can only be changed once every 30 days"));
                ...
                result.andExpect(status().isBadRequest())
                                .andExpect(jsonPath("$.message")
                                                .value("Nickname can only be changed once every 30 days"));
        }
