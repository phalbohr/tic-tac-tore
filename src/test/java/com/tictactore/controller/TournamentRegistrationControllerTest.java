...
@DisplayName("TournamentRegistrationController WebMvc Tests")
class TournamentRegistrationControllerTest {
    ...
    @Nested
    @DisplayName("Solo Registration (1v1 & 2v2 Random)")
    ...
    @Nested
    @DisplayName("2v2 Fixed Team Registration with Partner")
    ...
    @Nested
    @DisplayName("Invitation Accept & Decline")
    ...
    @Nested
    @DisplayName("Withdraw & Cancel Registration")
    ...
    @Nested
    @DisplayName("Validation Errors & Access Control")
    ...
    @Nested
    @DisplayName("Query Registrations & Status")
