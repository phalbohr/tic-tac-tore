...
class TournamentConfirmationDeadlineIT {
        ...
        @BeforeEach
        void setUp() {
                player1 = userRepository
                                .save(User.builder().email("p1_deadline@example.com").nickname("PlayerOne").build());
                player2 = userRepository
                                .save(User.builder().email("p2_deadline@example.com").nickname("PlayerTwo").build());
                ...
                var game = Game.builder()
                                ...
                                .gameOrder(1)
                                .build();
                coreMatch.addGame(game);
                coreMatch = matchRepository.save(coreMatch);
        ...
        @Test
        @DisplayName("Should auto-confirm expired match, complete tournament match, award winner, and complete tournament")
