...
class TournamentRegistrationRepositoryTest {
        ...
        void shouldFilterByTournamentIdAndStatus() {
                ...
                var confirmedList = registrationRepository.findByTournamentIdAndStatus(tournament.getId(),
                                RegistrationStatus.CONFIRMED);
                var pendingCount = registrationRepository.countByTournamentIdAndStatus(tournament.getId(),
