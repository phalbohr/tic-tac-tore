        ...
        try {
            jdbcTemplate.update("""
                INSERT INTO rule_configuration (
                    id, name, type, goal_limit, game_limit, win_by_two, absolute_score_cap,
                    ...
                    '50f4a8e2-888e-4f10-9173-67c8cbcf8f3a', 'ITSF Standard Matchplay', 'PRESET', 5, 5, TRUE, 8,
                    2, 30, 10, 15,
                    'BETWEEN_GAMES', 'CONCEDING_TEAM', FALSE, FALSE,
                    'BETWEEN_GAMES', 'WIN_LOSS_3_0', '00000000-0000-0000-0000-000000000000', CURRENT_TIMESTAMP, 0
            ...
            jdbcTemplate.update("""
                INSERT INTO rule_configuration (
                    ...
                    '1e4b85ab-2c84-4861-ba04-eb17a3a5e8dc', 'DTFB Standard', 'PRESET', 5, 3, FALSE, NULL,
                    2, 30, 10, 15,
                    'BETWEEN_GAMES', 'CONCEDING_TEAM', FALSE, FALSE,
                    'BETWEEN_GAMES', 'WIN_LOSS_3_0', '00000000-0000-0000-0000-000000000000', CURRENT_TIMESTAMP, 0
